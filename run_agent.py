...
class AIAgent:
    ...
    @staticmethod
    def _find_unanswered_tool_call(
        messages: List[Dict[str, Any]],
        tool_call_id: str,
        tool_name: str = "",
    ...
    def _append_external_tool_resume_result(
        self,
        messages: List[Dict[str, Any]],
        resume_tool_result: Dict[str, Any],
    ) -> None:
        ...
        if match is None:
            raise ValueError(
                "Cannot resume external tool result: unanswered tool call not "
                f"found or already answered (tool_call_id={tool_call_id!r}, "
    ...
    def resume_with_tool_result(
        ...
        *,
        ...
        if session_id and self.session_id != session_id:
            raise ValueError(
                f"resume session mismatch: agent={self.session_id!r} "
