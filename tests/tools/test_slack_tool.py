...
def test_read_thread_parses_permalink_and_fetches_replies(monkeypatch):
    ...
    monkeypatch.setattr("plugins.platforms.slack.adapter.slack_read_thread", fake_read_thread)
...
def test_read_channel_fetches_history(monkeypatch):
    ...
    monkeypatch.setenv("SLACK_BOT_TOKEN", "xoxb-test")
    monkeypatch.setattr("plugins.platforms.slack.adapter.slack_read_channel", fake_read_channel)
...
def test_channel_info_uses_native_gateway_helper(monkeypatch):
    ...
    monkeypatch.setenv("SLACK_BOT_TOKEN", "xoxb-test")
    monkeypatch.setattr("plugins.platforms.slack.adapter.slack_channel_info", fake_channel_info)
...
def test_list_channels_uses_native_gateway_helper(monkeypatch):
    ...
    monkeypatch.setenv("SLACK_BOT_TOKEN", "xoxb-test")
    monkeypatch.setattr("plugins.platforms.slack.adapter.slack_list_channels", fake_list_channels)
