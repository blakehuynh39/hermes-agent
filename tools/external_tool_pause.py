...
class ExternalToolPending(Exception):
    ...
    def __init__(self, payload: Dict[str, Any] | None = None, message: str = ""):
        ...
        super().__init__(message or str(self.payload.get("summary") or "external tool pending"))

    def to_dict(self, *, session_id: str = "", tool_call_id: str = "", tool_name: str = "") -> Dict[str, Any]:
