...
async def _read_thread(token: str, args: dict[str, Any]) -> str:
    ...
    from plugins.platforms.slack.adapter import slack_read_thread
...
async def _read_channel(token: str, args: dict[str, Any]) -> str:
    ...
    from plugins.platforms.slack.adapter import slack_read_channel
...
async def _channel_info(token: str, args: dict[str, Any]) -> str:
    ...
    from plugins.platforms.slack.adapter import slack_channel_info
...
async def _list_channels(token: str, args: dict[str, Any]) -> str:
    from plugins.platforms.slack.adapter import slack_list_channels
...
def _message_text(message: dict[str, Any]) -> str:
    ...
    if not text and message.get("blocks"):
        try:
            from plugins.platforms.slack.adapter import _extract_text_from_slack_blocks
